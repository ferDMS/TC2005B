...
*/
 ...
 CALL booksDB.insertBookPage(1, 
  'Mr. and Mrs. Dursley, of number four, Privet Drive, were proud to say that they were perfectly normal, thank you very much. They even got a bit annoyed when the milkman delivered cream instead of skimmed one morning, when Mrs. Dursley was particularly busy trying to make perfect meringues.');
CALL booksDB.insertBookPage(1, 
  'The Dursleys had everything they wanted, but they also had a secret, and their greatest fear was that somebody would discover it. They didn\'t think they could bear it if anyone found out about the Potters. Mrs. Potter was Mrs. Dursley\'s sister, but they hadn\'t met for several years; in fact, Mrs. Dursley pretended she didn\'t have a sister, because her sister was not normal.');
CALL booksDB.insertBookPage(1, 
  'The Dursleys shuddered to think what the neighbors would say. The Dursleys knew the Potters had been dead for quite some time. Mrs. Dursley shuddered to think what her sister had probably been up to before she died. Potters weren\'t folks you enforced the law on, in any case.');
CALL booksDB.insertBookPage(1, 
  'The Dursleys shuddered to think what the neighbors would say. Still, they couldn\'t help wondering what had happened to the Potters\' son, Harry. On their nephew, they\'d never spoken a word. It was setting a bad example, they sternly reminded themselves.');
CALL booksDB.insertBookPage(1, 
  'The Dursleys had tried, of course, just as hard as they could, to pretend Harry didn\'t exist. When Harry had been a baby and hadn\'t stopped crying for days, Mr. Dursley had threatened to throw him out the window, but Mrs. Dursley had begged him not to; she\'d had enough trouble with the neighbors without that.');
...
CALL booksDB.insertBookPage(2, 
  'The summer holidays were drawing to a close and the Dursleys were planning a grand finale – a trip to the seaside for Dudley\'s birthday. Harry Potter, unwanted son of Mr. and Mrs. Dursley, would naturally not be invited. Mrs. Dursley pretended she couldn\'t afford to take him; Mr. Dursley grumbled about the cost of extra food.');
CALL booksDB.insertBookPage(2, 
  'The truth, of course, was that they didn\'t want Harry tagging along. The Dursleys knew Harry hated the seaside. He never enjoyed the cold wind whipping his hair in his face, nor the salty spray that made his glasses blurry, nor the feeling of sand between his toes. But none of that mattered to the Dursleys.');
CALL booksDB.insertBookPage(2, 
  'They were going to enjoy themselves, and they didn\'t care how miserable Harry was. On their last morning at the seaside, Harry was left in Dudley\'s and Piers\' care while Mr. and Mrs. Dursley went shopping. A fight quickly broke out over a bucket and spade, and Harry, as always, got the blame.');
CALL booksDB.insertBookPage(2, 
  'Uncle Vernon, furious, decided to punish Harry by making him stay in his room for the whole of the next day. Harry lay on his bed with nothing to look forward to but a long, dull afternoon. He stared out of the tiny window, feeling very much like a caged bird.');
CALL booksDB.insertBookPage(2, 
  'That evening, just as the Dursleys sat down to a delicious-looking dinner of roast beef, there was a tapping on the window. Harry peered through the curtains. A large, snowy owl was fluttering outside. Harry watched, frozen, as the owl swooped down, landing next to the open window.');
